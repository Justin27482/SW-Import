      ...
      sendChat("Error on Weapon", "This attribute has been ignored.");
       ...
       //Create Static Weapon Attributes first:
        ...
        if(Weapon.MaxShots > 0 || Weapon.Shots > 0){
           createObj('attribute', {
               name: 'repeating_weapons_'+ Weapon.rowid +'_shots (current)',
               current: Weapon.Shots.toString() ,
               max: Weapon.MaxShots.toString(), 
               characterid: charID
           }); 
        }
        ...
        switch( Weapon.Type.toLowerCase() ){
            ...
            case 'thrown':
                ...
                createObj('attribute', {name: 'repeating_weapons_'+ Weapon.rowid +'_weapondamage',current: Weapon.DmgDieNum+Weapon.DmgDieType+'+'+Weapon.DmgBonusNum ,characterid: charID});
                createObj('attribute', {name: 'repeating_weapons_'+ Weapon.rowid +'_weapondmg',current: Weapon.DmgDieNum+Weapon.DmgDieType+'+'+Weapon.DmgBonusNum ,characterid: charID});
                createObj('attribute', {name: 'repeating_weapons_'+ Weapon.rowid +'_skillNDamage',current: '@{whisperweapon} &{template:roll} {{trait=@{athleticsname}}} {{source=@{weapon}}} @{rolltAthletics} @{unshakeTemplate} {{button=y}} {{ReRoll=^{reroll}(~repeating_weapons_tWeapon) }} {{DmgRoll=^{roll-damage}(~repeating_weapons_dmg) }} @{setmodsenc} @{showtraitmods} @{multiattack}' ,characterid: charID});
                break;
...
//Set all Skills to Unskilled roll Value!
SkillList = [];

SkillList[0]  = 'Academics';
SkillList[1]  = 'Athletics';
SkillList[2]  = 'Battle';
SkillList[3]  = 'Boating';
SkillList[4]  = 'Common Knowledge';
SkillList[5]  = 'Driving';
SkillList[6]  = 'Electronics';
SkillList[7]  = 'Faith';
SkillList[8]  = 'Fighting';
SkillList[9]  = 'Focus';
SkillList[10]  = 'Gambling';
SkillList[11]  = 'Hacking';
SkillList[12]  = 'Healing';
SkillList[13]  = 'Intimidation';
SkillList[14]  = 'Language';
SkillList[15]  = 'Notice';
SkillList[16]  = 'Occult';
SkillList[17]  = 'Performance';
SkillList[18]  = 'Persuasion';
SkillList[19]  = 'Piloting';
SkillList[20]  = 'Psionics';
SkillList[21]  = 'Repair';
SkillList[22]  = 'Research';
SkillList[23]  = 'Riding';
SkillList[24]  = 'Science';
SkillList[25]  = 'Shooting';
SkillList[26]  = 'Spellcasting';
SkillList[27]  = 'Stealth';
SkillList[28]  = 'Survival';
SkillList[29]  = 'Taunt';
SkillList[30]  = 'Thievery';
SkillList[31]  = 'Weird Science';
